...
Shared validation provider for Skills-Create-Project.
Migrated from super-skill-creator/scripts/quick_validate.py to _shared/scripts/
so that slice-experiment-lab and other skills can reference it without
depending on a sibling repo outside Skills-Create-Project.
