---
name: codex-subagent-setup-knowledge-base
kb_profile: canonical_design_kb
role: codex subagent setup baseline design
ver: 1
...
purpose: codex-subagent-setup을 directory-per-agent package로 운영하기 위한 local KB
---
...
This KB is the baseline canonical design source for `codex-subagent-setup` itself: package layout, role separation, progressive context rules, and built-in subagent composition.
