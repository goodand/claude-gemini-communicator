...
6. 구현은 `(→ references/vertical-slice-promotion-summary-at2026-03-17-03-08.md)` → `(→ references/vertical-slice-promotion-trigger-evaluator-at2026-03-17-03-14.md)` → `(→ references/vertical-slice-hybrid-kb-patch-plan-at2026-03-17-03-20.md)` → `(→ references/vertical-slice-apply-hybrid-kb-patch-at2026-03-17-03-27.md)` → `(→ references/vertical-slice-canonical-candidate-evaluator-at2026-03-17-03-36.md)` → `(→ references/vertical-slice-canonical-kb-patch-plan-at2026-03-17-09-03.md)` → `(→ references/vertical-slice-apply-canonical-kb-patch-at2026-03-17-09-08.md)` 순서로 따른다.
...
- `scripts/evidence_to_knowledge_promoter.py` — `apply-hybrid-kb-patch`
...
- `references/vertical-slice-apply-hybrid-kb-patch-at2026-03-17-03-27.md` — patch plan 실제 적용 slice 정의
...
- `references/vertical-slice-apply-canonical-kb-patch-at2026-03-17-09-08.md` — canonical KB patch plan 실제 적용 slice 정의
...
- 현재는 `apply-canonical-kb-patch`까지 구현됐고, canonical 승격은 여전히 candidate gate를 먼저 통과해야 한다.
