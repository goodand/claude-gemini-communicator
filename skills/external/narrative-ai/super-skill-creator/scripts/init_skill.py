...
EVALS_TEMPLATE = [
    {
        "name": "example_eval",
        "description": "TODO: describe what this eval tests",
        "prompt": "TODO: realistic user prompt",
        "expected": "TODO: describe expected behavior",
        "grading": {
            "type": "includes",
            "values": ["TODO"],
        },
...
def _find_skills_root() -> Path | None:
    """Walk up from CWD to find .claude/skills/ directory."""
    try:
...
def main():
    ...
    (root / "evals" / "evals.json").write_text(
        json.dumps(EVALS_TEMPLATE, indent=2, ensure_ascii=False) + "\n",
        encoding="utf-8",
    )
